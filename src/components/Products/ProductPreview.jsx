...
function ProductPreview() {
  return (
    <>
      <Link
        to={"/"}
        className="inline-block my-8 px-4 py-2 rounded bg-indigo-50 outline-none border border-indigo-100"
      >
        Back
      </Link>
      <section className="text-gray-600 body-font overflow-hidden bg-indigo-50 mb-8 rounded-lg">
