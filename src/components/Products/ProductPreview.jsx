...
function ProductPreview() {
  return (
    <section className="text-gray-600 body-font overflow-hidden bg-gray-200 my-8 rounded-lg">
        {/* <button type="button" className="w-8 h-8 absolute top-0.5 right-0.5 lg:top-[1rem] lg:right-[1rem] bg-slate-900 text-slate-200 outline hover:outline-2 hover:outline-slate-900 hover:bg-slate-200 hover:text-slate-900 rounded font-bold text-lg">x</button> */}
